...
--   * Name corrections vs old roster: Coward→Cohen, Roessier→Rosser,
--     Rob→"Rob (Adriel)", "Smith - Wright"→"Smith-Wright".
--   * "Hunter Hal" exists in the roster but is NOT in the sheet — left as-is
--     (delete it manually if it's a duplicate of Hunter Haley).
...
UPDATE public.coach_roster SET last_name='Cohen', phone='512-636-1595', email='divoga24@gmail.com' WHERE lower(first_name)='breanna' AND lower(last_name) IN ('coward','cohen');
...
UPDATE public.coach_roster SET first_name='Rob (Adriel)', phone='202-487-1439', email='adrielroberts97@gmail.com' WHERE lower(first_name) IN ('rob','rob (adriel)') AND lower(last_name)='roberts';
...
UPDATE public.practice_teams SET head_coach='Lindsey Shumway',     assistant_coach='Rob (Adriel) Roberts' WHERE team_name='11 Rise 1';
UPDATE public.practice_teams SET head_coach='Tara Fisher',         assistant_coach='Rene Sandoval'      WHERE team_name='12 Diamond';
UPDATE public.practice_teams SET head_coach='Rob (Adriel) Roberts', assistant_coach='Victoria Reyna'    WHERE team_name='12 Rise 1';
...
UPDATE public.practice_teams SET head_coach='Breanna Cohen',       assistant_coach='Sam Mabry'          WHERE team_name='13 Ruby';
...
UPDATE public.practice_teams SET head_coach='Hunter Haley',        assistant_coach='Breanna Cohen'      WHERE team_name='15 Diamond';
